...
import 'package:employee_db/services/event_services.dart';
...
class AddEventsPageState extends State<AddEventsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    _descriptionController.text =
        element != null ? element.description : 'Description';
      ...
      body: SafeArea(
            ...
            floatingActionButton:     FloatingActionButton(
                      ...
                      onPressed: () => element != null
                          ? this.firebaseService.updateEvent(
                              element.reference,
                          ...
                          : this
                              .firebaseService
                              .createEvent(_titleController.text, _dateController.text,
                                  _descriptionController.text)
                              .then((_) {
